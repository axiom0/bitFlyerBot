...
####################################################################
    ...
    def post_send_childorder(self, child_order_type, side, price, size,
        ...
        if child_order_type == "LIMIT":
            ...
            raise Exception("WrapperAPI/post_send_childorder : Illegal price or order type")

        return self.post("/v1/me/sendchildorder", body)

    #child_order_id or child_order_acceptance_id
    def post_cancel_childorder(self, child_order_acceptance_id, child_order_id=None):
    ...
    #order_method,minute_to_expire, time_in_force, parameters(see API reference) 
    def post_send_parentorder(self, order_method, parameters, minute_to_expire=43200, time_in_force="GTC"):
        body =  {
    ...
    #parent_order_id or parent_order_acceptance_id
    def post_cancel_parentorder(self, parent_order_acceptance_id, parent_order_id=None):
...
####################################################################
    ...
    def __mywrapper(self, path_url, method, body):
        ...
        if method == "GET":
            ...
            response = requests.post( base_url + path_url , data= data, headers = headers)
