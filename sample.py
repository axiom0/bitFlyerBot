...
def check_order( flag ):
	try:
		position = bitflyer.fetch_closed_orders( params = { "product_code" : "FX_BTC_JPY" })
...
def cancel_order( orders,flag ):
	try:
		...
		time.sleep(20)
		position = bitflyer.fetch_open_orders( params = { "product_code" : "FX_BTC_JPY" })
		if not position:
