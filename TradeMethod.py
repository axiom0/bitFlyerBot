        ...
        while True:
            try:
                ...
                if count > Tradeconfig.check_count:
                    self.d_message("TradeMethod/isCompleted : Failed to check that order has completed or not.")
                    raise Exception("TradeMethod/isCompleted : Failed to check that order has completed or not.")
            else:
                break
        ...
        while True:
            try:
                ...
                if count > Tradeconfig.check_count:
                    ...
                    raise Exception("TradeMethod/cancel_all_orders : Failed to Cancel All Orders.")
            else:
        ...
        while True:
            try:
                ...
                if count > Tradeconfig.buy_count:
                    self.d_message("TradeController buy_jdg : Failed to send buy signal.")
                    raise Exception("TradeController buy_jdg : Failed to send buy signal.")
            else:
                return result
        ...
        while True:
            try:
                ...
                if count > Tradeconfig.sell_count:
                    self.d_message("TradeMethod/sell_signal : Failed to send sell signal.")
                    raise Exception("TradeMethod/sell_signal : Failed to send sell signal.")
            else:
                return result
        ...
        while True:
            try:
                ...
                if count > Tradeconfig.close_count:
                    self.d_message("TradeMethod/close_Position : Failed to send close signal!!!!!!!!!")
                    self.d_message("TradeMethod/close_Position : Failed to send close signal!!!!!!!!!")
                    self.d_message("TradeMethod/close_Position : Failed to send close signal!!!!!!!!!")
                    raise Exception("TradeMethod/sell_signal : Failed to send sell signal.")
            else:
    ...
    def get_open_order(self):
        ...
        while True:
            try:
                ...
                count+=1
                if count > Tradeconfig.check_count:
                    self.d_message("TradeMethod/get_open_order : Failed to check orders.")
                    raise Exception("TradeMethod/get_open_order  : Failed to check orders.")
            else:
                break
        ...
        while True:
            try:
                ...
                if count > Tradeconfig.check_count:
                    ...
                    raise Exception("TradeMethod/get_balance : Failed to check balances.")
    ...
    def get_order(self, id):
        ...
        while True:
            try:
                ...
                count+=1
                if count > Tradeconfig.check_count:
                    self.d_message("TradeMethod/get_order : Failed to check order .")
                    raise Exception("TradeMethod/get_order : Failed to check order.")
            else:
                break
        ...
        while True:
            try:
                ...
                if count > Tradeconfig.get_board_count:
                    self.d_message("TradeMethod/calc_buy_amount_price : Failed to get board.")
                    raise Exception("TradeMethod/calc_buy_amount_price : Failed to get board.")
            else:
                break
